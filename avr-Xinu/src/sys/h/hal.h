...
#include "../h/enc28j60.h"
#include "../h/enc28j60_packet.h"
 ...
 */
#define hal_receive_packet(buffer, buffer_len) enc28j60_receive_packet((buffer), (buffer_len))
 ...
 */
#define hal_send_packet(buffer, buffer_len) enc28j60_send_packet((buffer), (buffer_len))
 ...
 */
#define hal_link_up() enc28j60_link_up()
